...
class User(models.Model):
    ...
    class Meta:
        db_table = 'User'  # Match the exact table name in the database
...
class Accommodation(models.Model):
    ...
    class Meta:
        db_table = 'Accommodation'  # Match the exact table name in the database
        managed = False            # Tell Django this table is managed externally
...
class Reservation(models.Model):
    ...
    class Meta:
        db_table = 'Reservation'  # Match the exact table name in the database
        managed = False          # Tell Django this table is managed externally
...
class Rating(models.Model):
    ...
    class Meta:
        db_table = 'Rating'  # Match the exact table name in the database
        managed = False     # Tell Django this table is managed externally
...
class Campus(models.Model):
    ...
    class Meta:
        db_table = 'Campus'  # Match the exact table name in the database
        managed = False     # Tell Django this table is managed externally
