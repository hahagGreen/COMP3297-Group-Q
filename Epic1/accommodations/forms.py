...
class AccommodationSearchForm(forms.Form):
    ...
    min_beds = forms.IntegerField(required=False, min_value=1, label='Minimum Beds')
    min_bedrooms = forms.IntegerField(required=False, min_value=1, label='Minimum Bedrooms')
